...
export declare function connectPuppeteerBrowser(puppeteer: typeof import("puppeteer-core").default, browserURL: string, attempts: number): Promise<PuppeteerBrowser | null>;
